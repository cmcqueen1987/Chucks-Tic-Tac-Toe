...
var winRow = function winRow() {
  if ($('#0').text() === $('#1').text() && $('#1').text() === $('#2').text() && $('#0').text() !== '' || $('#3').text() === $('#4').text() && $('#4').text() === $('#5').text() && $('#3').text() !== '' || $('#6').text() === $('#7').text() && $('#7').text() === $('#8').text() && $('#6').text() !== '') {
    return true;
  } else {
    return false;
  }
...
var winColumn = function winColumn() {
  if ($('#0').text() === $('#3').text() && $('#3').text() === $('#6').text() && $('#0').text() !== '' || $('#1').text() === $('#4').text() && $('#4').text() === $('#7').text() && $('#1').text() !== '' || $('#2').text() === $('#5').text() && $('#5').text() === $('#8').text() && $('#2').text() !== '') {
    return true;
  } else {
    return false;
  }
...
var winDiagonal = function winDiagonal() {
  if ($('#4').text() === $('#0').text() && $('#0').text() === $('#8').text() && $('#4').text() !== '' || $('#4').text() === $('#6').text() && $('#6').text() === $('#2').text() && $('#4').text() !== '') {
    return true;
  } else {
    return false;
  }
